...
<template>
  <div class="block featured-apps">
    <div class="featured-app" v-for="app in apps" :key="app.id">
      <f7Link noLinkClass :href="`/app/${app.id}`" :routeProps="{ backText }">
        ...
        <img
          loading="lazy"
          class="featured-app-image"
          :alt="app.title"
          :src="useIcon ? app.icon : app.screenshots[0]"
        />
      </f7Link>
    </div>
  </div>
